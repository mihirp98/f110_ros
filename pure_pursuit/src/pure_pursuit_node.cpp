...
private:
    ...
    ros::Publisher vis_array_pub1;
    ros::Publisher vis_array_pub2;
    ros::Publisher vis_array_pub3;
    ros::Publisher vis_array_pub4;
    ros::Publisher vis_array_pub5;
    ros::Publisher vis_array_pub6;
    ros::Publisher vis_array_pub7;
    ros::Subscriber pose_sub;
    visualization_msgs::Marker marker;
    visualization_msgs::MarkerArray markers_array1;
    visualization_msgs::MarkerArray markers_array2;
    visualization_msgs::MarkerArray markers_array3;
    visualization_msgs::MarkerArray markers_array4;
    visualization_msgs::MarkerArray markers_array5;
    visualization_msgs::MarkerArray markers_array6;
    visualization_msgs::MarkerArray markers_array7;
    ackermann_msgs::AckermannDriveStamped drive_msg;

    double x_current, y_current, yaw_curr, minDistance1, minDistance2, steering_angle;
    double waypoint_x, waypoint_y;
    double speed;
    std::vector<vector<double>> waypoints1, tranformed_waypoints;
    std::vector<vector<double>> waypoints2;
    std::vector<vector<double>> waypoints3;
    std::vector<vector<double>> waypoints4;
    std::vector<vector<double>> waypoints5;
    std::vector<vector<double>> waypoints6;
    std::vector<vector<double>> waypoints7;
    string filename1_;
    string filename2_;
    string filename3_;
    string filename4_;
...
public:
    PurePursuit() {
        ...
        filename1_ = "/home/mihir/mihir_ws/src/f110_ros/f110_finalProject/waypoints_data/wp_centre.csv";
        filename2_ = "/home/mihir/mihir_ws/src/f110_ros/f110_finalProject/waypoints_data/yaw_wp_inner0.75.csv";
        filename3_ = ("/home/mihir/mihir_ws/src/f110_ros/f110_finalProject/waypoints_data/yaw_wp_inner1.0.csv");
        filename4_ = "/home/mihir/mihir_ws/src/f110_ros/f110_finalProject/waypoints_data/yaw_wp_outer0.5.csv";
        filename5_ = "/home/mihir/mihir_ws/src/f110_ros/f110_finalProject/waypoints_data/yaw_wp_outer0.75.csv";
        filename6_ = ("/home/mihir/mihir_ws/src/f110_ros/f110_finalProject/waypoints_data/multiwp1.csv");
        filename7_ = ("/home/mihir/mihir_ws/src/f110_ros/f110_finalProject/waypoints_data/yaw_wp_inner1.0.csv");
        // filename8_ = "/home/mihir/mihir_ws/src/f110_ros/f110_finalProject/waypoints_data/multiwp1.csv";
        L = 2.5;
        ...
        vis_array_pub1 = n.advertise<visualization_msgs::MarkerArray>( "/waypoint_vis_array1", 1 );
        vis_array_pub2 = n.advertise<visualization_msgs::MarkerArray>( "/waypoint_vis_array2", 1 );
        vis_array_pub3 = n.advertise<visualization_msgs::MarkerArray>( "/waypoint_vis_array3", 1 );
        vis_array_pub4 = n.advertise<visualization_msgs::MarkerArray>( "/waypoint_vis_array4", 1 );
        vis_array_pub5 = n.advertise<visualization_msgs::MarkerArray>( "/waypoint_vis_array5", 1 );
        vis_array_pub6 = n.advertise<visualization_msgs::MarkerArray>( "/waypoint_vis_array6", 1 );

        get_data(waypoints1, filename1_);
        get_data(waypoints2, filename2_);     
        get_data(waypoints3, filename3_);
        get_data(waypoints4, filename4_);
        get_data(waypoints5, filename5_);     
        get_data(waypoints6, filename6_);
        
        
    }

    void get_data(std::vector<vector<double>> &waypoints, std::string& filename_)
        {
    ...
    void get_best_waypoint(const std::vector<vector<double>> &waypoints, double &waypoint_x, double &waypoint_y, int minIndex1, int minIndex2, double minDistance1, double minDistance2){
        if(minDistance1 == 0.0){
    ...
    void pose_callback(const geometry_msgs::PoseStamped::ConstPtr &pose_msg) {
        ...
        tranformed_waypoints = get_transformed_waypoints(waypoints1);
        // print_waypoints(tranformed_waypoints);

        // markers_array = get_all_markers(waypoints);

        markers_array1 = get_all_markers(waypoints1);
        vis_array_pub1.publish(markers_array1);
        // vis_array_pub.publish(markers_array);

        markers_array2 = get_all_markers(waypoints2);
        vis_array_pub2.publish(markers_array2);

        markers_array3 = get_all_markers(waypoints3);
        vis_array_pub3.publish(markers_array3);

        markers_array4 = get_all_markers(waypoints4);
        vis_array_pub4.publish(markers_array4);
        // vis_array_pub.publish(markers_array);

        markers_array5 = get_all_markers(waypoints5);
        vis_array_pub5.publish(markers_array5);

        markers_array6 = get_all_markers(waypoints6);
        vis_array_pub6.publish(markers_array6);
